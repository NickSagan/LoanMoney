...
extension NewsVC: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imageNews.image = UIImage(named: data.news[indexPath.row].image)
        cell.titleNews.text = data.news[indexPath.row].title
        cell.textNews.text = data.news[indexPath.row].text
        return cell
    }
}
